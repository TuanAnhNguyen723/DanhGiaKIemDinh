...
<div id="updateModal" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" method="POST" action="">
      ...
      <input type="userEmail" id="userEmail" name="userEmail"><br>
...
<script>
  ...
  window.onclick = function(event) {
      ...
      if (event.target == modal) {
            ...
            xhr.onload = function () {
                if (xhr.status == 200) {
                    ...
                    if (product.error) {
                        ...
                        document.getElementById("userId").value = product.id; // Cập nhật productId
                        document.getElementById("userName").value = product.username;
                        document.getElementById("userEmail").value = product.email;
        ...
        function deleteProduct(usersId) {
            ...
            btnYes.onclick = function () {
                ...
                xhr.send("deleteProduct=true&productId=" + usersId);
