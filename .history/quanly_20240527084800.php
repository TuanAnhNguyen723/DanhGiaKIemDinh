...
<table>
    <tr>
        ...
        <th scope="col" onclick="sortTable(0, false, true)">Username &#x2191;</th>
        <th scope="col" onclick="sortTable(0, false, true)">Email &#x2191;</th>
        <th scope="col" onclick="sortTable(0, true, true)">Số nước tiêu thụ (m³) &#x2191;</th>
        <th scope="col" onclick="sortTable(0, true, true)">Tổng tiền (VND) &#x2191;</th>
        <th>Role</th>
        <th>Hành động</th>
    </tr>
    <?php
